...
func _physics_process(delta: float) -> void:
	...
	SPEED = move_toward(SPEED, target_speed, abs(target_speed - SPEED) * delta)
	JUMP_VELOCITY = move_toward(JUMP_VELOCITY, target_jump, abs(target_jump - JUMP_VELOCITY) * delta)
